...
The encoding/base64 package encodes and decodes base64 data.
	...
	var lib = require('encoding/base64');
	var enc = lib.encode("This is some text");
	var dec = lib.decode(enc);
	console.log(enc, dec);

It is also possible to decode base64 data directly from a reader.
...
It is also possible to encode base64 data directly to a writer.
